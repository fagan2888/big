...
#Expression = ['close_EMA_5#close_EMA_10&cross','J#D&cross*K#D&cross*J#70#0&thre','RSI_6#RSI_12&cross*RSI_6#80#0&thre','close_EMA_12#close_EMA_26&cross','RSI_6#RSI_12&cross','J#D&cross*K#D&cross','MACD#0#0&thre&HS']
Expression = ['close_EMA_5#close_EMA_10&cross','RSI_6#85#1&thre','J#100#1&thre','close_EMA_12#close_EMA_26&cross&HS','K#40#1&thre&HS']#'close_EMA_5#2#1&trend']
dp_code = '999999.XSHG'
...
class Worth:
    ...
    def get_operation(self,):
        if(not self.now_bar.empty):
            ...
            if(self.expre_Sig[0] == 2 and self.expre_Sig[4] == 1): #and self.expre_Sig[6] == 0): #or self.expre_Sig[2] == 2):
                self.operation = 1
            elif(self.expre_Sig[1] == 1 or self.expre_Sig[2] == 1 or self.expre_Sig[3] == 1 or self.expre_Sig[4] == 0): #加入全局风控
                self.operation = -1
...
if __name__ == "__main__":
    code_list = ['000001.XSHE']#,'000027.XSHE','000046.XSHE']
    ...
    #code_list = ['600446.XSHG']
    #for begin_year in range(2018,2020):
    begin_year = 2018
