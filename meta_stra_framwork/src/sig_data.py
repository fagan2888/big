...
def cal_index_data(code):
    try:
        ...
        data = index_24.calculatemultiply(data,index_name = 'close_shift_1',rate = 1.02)
        data = index_24.calculatemultiply(data,index_name = 'close_shift_1',rate = 1.01)
        data = index_24.calculatemultiply(data,index_name = 'close_shift_1',rate = 1.03)
        data = index_24.calculatemultiply(data,index_name = 'close_shift_1',rate = 1.04)
        data = index_24.calculatemultiply(data,index_name = 'close_shift_1',rate = 1.05)
        data = index_24.calculatemultiply(data,index_name = 'close_shift_1',rate = 1.005)
        data = index_24.calculatemultiply(data,index_name = 'close_shift_1',rate = 1.001)
