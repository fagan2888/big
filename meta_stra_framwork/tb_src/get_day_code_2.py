...
def email(estr,subject):
    username = 'lsz495506796@163.com'
    password = 'mnbb456123'
    now_time = time.strftime("%Y%m%d", time.localtime())

    msg = MIMEMultipart('mixed') 
    msg['Subject'] = now_time+' '+subject
    msg['From'] = 'lsz495506796@163.com <lsz495506796@163.com>'
    msg['To'] = 'lsz17801016296@163.com'
    ...
    smtp.sendmail('lsz495506796@163.com','lsz17801016296@163.com', msg.as_string()) 
    smtp.quit()


def get_day_code():
    param =  params_2.PARAMS
